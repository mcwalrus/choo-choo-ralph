---
name: spec
description: Generate or refine a spec file for Choo Choo Ralph from your plan. Use when running /choo-choo-ralph:spec or creating task breakdowns from a plan.
---
...
See [the spec-generation skill](../spec-generation/SKILL.md) for the full spec format reference.
